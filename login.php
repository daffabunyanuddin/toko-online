        ...
        <div class="p-6 space-y-6 sm:p-8">
            <h1 class="text-3xl font-bold text-center text-gray-900 mb-4">
                <span class="inline-flex items-center">
                    ...
                    <span class="ml-2">Login Pelanggan</span>
                </span>
            </h1>
            <form class="space-y-6" action="proses_login.php" method="post" aria-label="Login Form">
                ...
                <p class="text-sm font-light text-center text-gray-500">
                    Don’t have an account? <a href="tambah_pelangan.php" class="font-medium text-primary-500 hover:underline">Sign up</a>
                </p>
                <a href="login_petugas.php" class="w-full text-center block text-primary-500 bg-gray-100 hover:bg-gray-200 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 transition duration-300 ease-in-out transform hover:scale-105">
